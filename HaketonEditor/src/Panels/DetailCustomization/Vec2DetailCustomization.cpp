...
namespace Haketon
{
    bool Vec2PropertyDetailCustomization::CustomizeDetails(rttr::variant& Value, rttr::property& Property, bool bReadOnly)
    {
        ...
        FVec2 value = convertToDegrees ? glm::degrees(Value.get_value<FVec2>()) : Value.get_value<FVec2>();
    ...
    bool Vec2PropertyDetailCustomization::DrawVec2Control(const std::string& label, FVec2& values, float resetValue, float columnWidth)
    {
