...
namespace Haketon
{
    ...
    {
        DrawQuad({position.x, position.y, 0.0f}, 0.0f, { 1.0f, 1.0f }, color);
    }
    ...
    void Renderer2D::DrawQuad(const glm::vec2& position, const Ref<Texture2D>& texture)
    {
        DrawQuad(position, 0.0f, { 1.0f, 1.0f }, texture);
    }
